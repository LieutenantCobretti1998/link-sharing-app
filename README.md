...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](frontend/link-sharing-app/README-template.md) file in this starter code.
