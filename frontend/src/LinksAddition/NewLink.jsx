        ...
        <div
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input required onChange={handleUrlChange} placeholder={findLinkById.url} className={`relative w-full pl-10 bg-white p-3 border-[.5px] rounded-md ${(errors?.emptyUrl || errors?.invalidPlatform || errors?.invalidUrl) ? "border-red" : "border-lightBlack-2"} focus:outline-primaryPurple`} type="text"/>
                    {errors?.emptyUrl && (
