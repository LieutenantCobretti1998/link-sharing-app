        ...
        return (
            <header
                ...
                <div className="flex gap-10 justify-center items-center">
                        <NavLink to="/settings">
                            <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512" width="30" height="30">
                                <path
                                    ...
                                    fill="black" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                    strokeWidth="32"/>
                            </svg>
                        </NavLink>
                    <Button type="header">
                        <NavLink className="w-full, h-full block pt-1" to={`${profileName}/create-links`}>Create New
                            Group</NavLink>
                    </Button>
                </div>
            </header>
