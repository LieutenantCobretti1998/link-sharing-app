...
function Header() {
    ...
    return (
        <header className="flex flex-row flex-md-row align-items-center bg-white p-5 m-2 mb-4 justify-between font-instrumentBold">
            <div>
            ...
            <div className="flex items-center gap-7">
                <Button type="links" isActive={location.pathname === "/"}>
                    <NavLink onClick={(e) => {
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 21 20">
                            <path className="group-hover:fill-primaryPurple transition duration-300 ease-in-out" fill="#737373"
                ...
                <div>
                    <Button type="links" isActive={location.pathname === "/profile"}>
                        <NavLink to="/profile"  className="p-3 py-1 flex items-center gap-0.5 justify-center w-max group">
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 21 20">
                                <path className="group-hover:fill-primaryPurple transition duration-300 ease-in-out"  fill="#737373"
            ...
            <div>
                <Button type="header">Preview</Button>
            </div>
        </header>
    );
}
